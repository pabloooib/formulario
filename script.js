...
/* ==================================================================
   REVELADO SUAVE AL HACER SCROLL — las tarjetas aparecen con un
   fundido y desplazamiento sutil al entrar en el viewport.
   ================================================================== */
function initScrollReveal(){
  const tarjetas = document.querySelectorAll('.card');
  if(!('IntersectionObserver' in window)){
    tarjetas.forEach(t => t.classList.add('in-view'));
    return;
  }
...
/* ==================================================================
   STEPPER — vástago de progreso (scroll-spy) + navegación móvil
   ================================================================== */
